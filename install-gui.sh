...
# Allows overriding the branch or commit to build in ethgreen-blockchain-gui
SUBMODULE_BRANCH=$1
...
# https://github.com/ethgreen/ethgreen-blockchain/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `ethgreen version` to version property of GUI's package.json
