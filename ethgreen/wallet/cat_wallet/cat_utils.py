...
from ethgreen.types.spend_bundle import CoinSpend, SpendBundle
from ethgreen.util.condition_tools import conditions_dict_for_solution
...
def next_info_for_spendable_cat(spendable_cat: SpendableCAT) -> Program:
    ...
    # https://github.com/ethgreen/clvm/pull/102
