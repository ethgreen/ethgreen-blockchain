...
from ethgreen.util.config import selected_network_address_prefix
...
class AddressType(Enum):
    ...
    def hrp(self, config: Dict[str, Any]) -> str:
        if self == AddressType.XETH:
            # Special case to map XETH to the current network's address prefix
