...
from ethgreen.util.streamable import Streamable, _T_Streamable
...
if TYPE_CHECKING:
    ...
    converted_api_f_type = Union[
        ...
        Callable[[Union[bytes, _T_Streamable], WSETHgreenConnection], Coroutine[Any, Any, Optional[Message]]],
    ]

    initial_api_f_type = Union[
        Callable[[Any, _T_Streamable], Coroutine[Any, Any, Optional[Message]]],
        Callable[[Any, _T_Streamable, WSETHgreenConnection], Coroutine[Any, Any, Optional[Message]]],
    ]

metadata_attribute_name = "_ethgreen_api_metadata"
