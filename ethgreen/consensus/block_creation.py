...
from ethgreen.consensus.coinbase import create_donationwallet_coin, create_farmer_coin, create_pool_coin
...
from ethgreen.types.blockchain_format.reward_chain_block import RewardChainBlock, RewardChainBlockUnfinished
...
def create_foliage(
    ...
    donationwallet_reward_puzzlehash: bytes32,
    ...
    Args:
        ...
        donationwallet_reward_puzzlehash: where to pay out donationwallet reward
    ...
    foliage_data = FoliageBlockData(
        ...
        donationwallet_reward_puzzlehash,
        extension_data,
    )
    ...
    if is_transaction_block:
        ...
        if height > 0:
            ...
            donationwallet_coin = create_donationwallet_coin(
                curr.height,
                constants.GENESIS_PRE_FARM_DONATIONWALLET_PUZZLE_HASH,
                calculate_base_donationwallet_reward(curr.height),
                constants.GENESIS_CHALLENGE,
            )
            
            assert curr.header_hash == prev_transaction_block.header_hash
            reward_claims_incorporated += [pool_coin, farmer_coin, donationwallet_coin]
...
def create_unfinished_block(
    ...
    donationwallet_reward_puzzle_hash: bytes32,
    pool_target: PoolTarget,
    get_plot_signature: Callable[[bytes32, G1Element], G2Element],
    get_pool_signature: Callable[[PoolTarget, Optional[G1Element]], Optional[G2Element]],
    ...
    Args:
        ...
        donationwallet_reward_puzzle_hash: where to pay out donationwallet rewards
    ...
    (foliage, foliage_transaction_block, transactions_info,) = create_foliage(
        ...
        donationwallet_reward_puzzle_hash,
        pool_target,
        get_plot_signature,
        get_pool_signature,
        seed,
