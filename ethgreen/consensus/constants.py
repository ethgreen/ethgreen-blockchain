...
class ConsensusConstants:
    ...
    # Forks of ethgreen should change this value to provide replay attack protection
    ...
    GENESIS_PRE_FARM_DONATIONWALLET_PUZZLE_HASH: bytes32  # The block at height must pay out to this farmer puzzle hash
    ...
    # Max coin amount uint(1 << 64). This allows coin amounts to fit in 64 bits. This is around 18M ethgreen.
    MAX_COIN_AMOUNT: int
