...
from ethgreen.cmds.init_funcs import create_all_ssl, create_default_ethgreen_config
...
from ethgreen.consensus.coinbase import create_farmer_coin, create_pool_coin, create_puzzlehash_for_pk
from ethgreen.consensus.condition_costs import ConditionCost
...
from ethgreen.consensus.deficit import calculate_deficit
from ethgreen.consensus.full_block_to_block_record import block_to_block_record
from ethgreen.consensus.make_sub_epoch_summary import next_sub_epoch_summary
from ethgreen.consensus.pot_iterations import (
    calculate_ip_iters,
...
from ethgreen.consensus.vdf_info_computation import get_signage_point_vdf_info
from ethgreen.daemon.keychain_proxy import KeychainProxy, connect_to_keychain_and_validate, wrap_local_keychain
from ethgreen.full_node.bundle_tools import (
    best_solution_generator_from_template,
    detect_potential_template_generator,
    simple_solution_generator,
)
from ethgreen.full_node.generator import setup_generator_args
from ethgreen.full_node.mempool_check_conditions import GENERATOR_MOD
from ethgreen.full_node.signage_point import SignagePoint
from ethgreen.plotting.create_plots import PlotKeys, create_plots
from ethgreen.plotting.manager import PlotManager
from ethgreen.plotting.util import (
    PlotRefreshEvents,
    PlotRefreshResult,
...
from ethgreen.simulator.socket import find_available_listen_port
from ethgreen.simulator.ssl_certs import (
...
from ethgreen.simulator.time_out_assert import time_out_assert_custom_interval
...
from ethgreen.types.blockchain_format.coin import Coin, hash_coin_ids
from ethgreen.types.blockchain_format.foliage import Foliage, FoliageBlockData, FoliageTransactionBlock, TransactionsInfo
...
from ethgreen.types.blockchain_format.proof_of_space import ProofOfSpace
from ethgreen.types.blockchain_format.reward_chain_block import RewardChainBlockUnfinished
from ethgreen.types.blockchain_format.sized_bytes import bytes32
from ethgreen.types.blockchain_format.slots import (
...
from ethgreen.types.generator_types import BlockGenerator, CompressorArg
...
from ethgreen.util.block_cache import BlockCache
from ethgreen.util.config import config_path_for_filename, load_config, lock_config, override_config, save_config
...
from ethgreen.util.keychain import Keychain, bytes_to_mnemonic
from ethgreen.util.prev_transaction_block import get_prev_transaction_block
from ethgreen.util.vdf_prover import get_vdf_info_and_proof
...
class BlockTools:
    ...
    def __init__(
        ...
        if automated_testing:
            ...
            create_default_ethgreen_config(root_path)
            create_all_ssl(
                root_path,
    ...
    async def setup_keys(self, fingerprint: Optional[int] = None, reward_ph: Optional[bytes32] = None):
        if self.local_keychain:
            ...
            keychain_proxy = await connect_to_keychain_and_validate(
                self.root_path, self.log, user="testing-1.8.0", service="ethgreen-testing-1.8.0"
            )
        ...
        if len(self.pool_pubkeys) == 0 or len(self.farmer_pubkeys) == 0:
            raise RuntimeError("Keys not generated. Run `ethgreen keys generate`")
        ...
        try:
            if plot_keys is None:
                ...
                if pool_contract_puzzle_hash is None:
                    ...
                    pool_address = encode_puzzle_hash(pool_contract_puzzle_hash, "xeth")
