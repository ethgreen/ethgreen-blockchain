...
from ethgreen.protocols.protocol_state_machine import message_response_ok
from ethgreen.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
...
from ethgreen.util.network import class_for_type, is_localhost
...
class WSETHgreenConnection:
    ...
    async def perform_handshake(
        ...
        if self.is_outbound:
            ...
            if inbound_handshake.network_id != 'ethgreen-' + network_id:
