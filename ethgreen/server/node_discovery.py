...
from ethgreen.protocols import full_node_protocol, introducer_protocol
...
from ethgreen.server.address_manager_sqlite_store import create_address_manager_from_db
from ethgreen.server.outbound_message import NodeType, make_msg, Message
...
class FullNodeDiscovery:
    ...
    async def on_connect_callback(self, peer: ws.WSETHgreenConnection):
