...
from ethgreen.cmds.wallet_funcs import print_balance, wallet_coin_unit
from ethgreen.pools.pool_config import load_pool_config, PoolWalletConfig, update_pool_config
...
from ethgreen.util.bech32m import encode_puzzle_hash, decode_puzzle_hash
...
from ethgreen.cmds.cmds_util import transaction_submitted_msg, transaction_status_msg, get_any_service_client
...
async def create(args: dict, wallet_client: WalletRpcClient, fingerprint: int) -> None:
    ...
    fee_mojos = uint64(int(fee * units["ethgreen"]))
    ...
    if user_input.lower() == "y" or user_input.lower() == "yes":
        try:
            ...
            print(f"Error creating plot NFT: {e}\n    Please start both farmer and wallet with:  ethgreen start -r farmer")
        return
    print("Aborting.")
