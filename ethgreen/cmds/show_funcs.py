...
async def print_blockchain_state(node_client: FullNodeRpcClient, config: Dict[str, Any]) -> bool:
    ...
    if synced:
        ...
        print("You may be able to expedite with 'ethgreen show -a host:port' using a known node.\n")
...
async def print_block_from_hash(
    ...
    if block is not None:
        ...
        donationwallet_address = encode_puzzle_hash(block.donationwallet_puzzle_hash, address_prefix)
        ...
        print(
            ...
            f"Community Address      {donationwallet_address}\n"
