...
from ethgreen.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'ethgreen show -c' has been renamed to 'ethgreen peer -c' ")
    if add_connection != "":
        print("'ethgreen show -a' has been renamed to 'ethgreen peer -a' ")
    if remove_connection != "":
        print("'ethgreen show -r' has been renamed to 'ethgreen peer -r' ")
    if wallet_rpc_port is not None:
        print("'ethgreen show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
