...
from ethgreen.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56888"
            testnet_introducer = "beta1_introducer.eth-green.com"
            testnet_dns_introducer = "dns-introducer.eth-green.com"
            testnet = "testnet7"
