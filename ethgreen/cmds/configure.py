...
from ethgreen.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "56262"
                testnet_introducer = "introducer-testnet10.eth-green.com"
                testnet_dns_introducer = "dns-introducer-testnet10.eth-green.com"
                bootstrap_peers = ["testnet10-node.eth-green.com"]
                testnet = "testnet10"
                ...
                mainnet_port = "6262"
                mainnet_introducer = "introducer.eth-green.com"
                mainnet_dns_introducer = "dns-introducer.eth-green.com"
                bootstrap_peers = ["node.eth-green.com"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running ethgreen services for changes to take effect")
