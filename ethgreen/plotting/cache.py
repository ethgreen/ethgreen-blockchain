...
from ethgreen.plotting.util import parse_plot_info
...
from ethgreen.util.misc import VersionedBlob
        ...
        try:
            ...
            if stored_cache.version == CURRENT_VERSION:
                ...
                for path, cache_entry in cache_data.entries:
                    ...
                    #       Related: - https://github.com/ethgreen/ethgreen-blockchain/issues/13084
                    #                - https://github.com/ethgreen/chiapos/pull/337
                    ...
                    # See https://github.com/ethgreen/chiapos/blob/3ee062b86315823dd775453ad320b8be892c7df3/src/prover_disk.hpp#L282-L287  # noqa: E501
