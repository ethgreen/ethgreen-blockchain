...
from ethgreen.data_layer.data_layer_errors import KeyNotFoundError
from ethgreen.data_layer.data_layer_util import (
    DiffData,
    InternalNode,
    KeyValue,
    Layer,
...
from ethgreen.data_layer.data_layer_wallet import DataLayerWallet, Mirror, SingletonRecord, verify_offer
from ethgreen.data_layer.data_store import DataStore
from ethgreen.data_layer.download_data import insert_from_delta_file, write_files_for_root
...
class DataLayer:
    ...
    async def on_connect(self, connection: WSETHgreenConnection) -> None:
        pass
