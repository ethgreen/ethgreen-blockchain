...
from ethgreen.data_layer.data_layer_errors import KeyNotFoundError, NodeHashError, TreeGenerationIncrementingError
...
class DataStore:
    ...
    async def _insert_root(
        ...
        # https://github.com/ethgreen/ethgreen-blockchain/pull/9284
    ...
    async def _insert_terminal_node(self, key: bytes, value: bytes) -> bytes32:
        ...
        # https://github.com/ethgreen/clvm/pull/106
