...
from ethgreen.data_layer.data_layer_wallet import Mirror, SingletonRecord
from ethgreen.pools.pool_wallet_info import PoolWalletInfo
from ethgreen.rpc.rpc_client import RpcClient
...
class WalletRpcClient(RpcClient):
    """
    Client to ETHgreen RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    ...
    async def nft_mint_bulk(
        ...
        xeth_coins: Optional[List[Dict]] = None,
        xeth_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "xeth_change_target": xeth_change_target,
