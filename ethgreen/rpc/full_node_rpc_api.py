...
from ethgreen.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR
...
from ethgreen.rpc.rpc_server import Endpoint, EndpointResult
...
from ethgreen.util.log_exceptions import log_exceptions
from ethgreen.util.ws_message import WsRpcMessage, create_payload_dict
from ethgreen.wallet.puzzles.decompress_block_spends import DECOMPRESS_BLOCK_SPENDS
...
class FullNodeRpcApi:
    def __init__(self, service: FullNode):
        ...
        self.service_name = "ethgreen_full_node"
