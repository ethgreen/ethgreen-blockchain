...
from ethgreen.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from ethgreen.rpc.data_layer_rpc_util import marshal
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "ethgreen_data_layer"
