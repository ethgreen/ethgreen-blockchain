"""
NOTE: This contains duplicate code from `ethgreen.cmds.plots`.
After `ethgreen plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "ETHgreen Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_ethgreen(args, root_path):
    try:
