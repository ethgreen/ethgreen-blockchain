...
from ethgreen.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
...
from ethgreen.server.ws_connection import NodeType, ProtocolMessageTypes, WSETHgreenConnection, make_msg
from ethgreen.util.generator_tools import list_to_batches
from ethgreen.util.ints import int16, uint32, uint64
...
class Sender:
    ...
    _connection: Optional[WSETHgreenConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSETHgreenConnection) -> None:
