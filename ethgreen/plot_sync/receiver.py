...
from ethgreen.plot_sync.exceptions import (
...
from ethgreen.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
class Receiver:
    _connection: WSETHgreenConnection
    _current_sync: Sync
    _last_sync: Sync
    ...
    def connection(self) -> WSETHgreenConnection:
