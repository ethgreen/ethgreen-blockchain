...
from ethgreen.full_node.full_node_store import FullNodeStore
...
from ethgreen.util.errors import ConsensusError, Err
...
class FullNode:
    ...
    async def peak_post_processing(
        self, block: FullBlock, record: BlockRecord, fork_height: uint32, peer: Optional[ws.WSethgreenConnection]
    ):
        """
