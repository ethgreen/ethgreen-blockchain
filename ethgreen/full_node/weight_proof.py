...
from ethgreen.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
from ethgreen.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
...
from ethgreen.types.weight_proof import (
...
def _create_shutdown_file() -> IO:
    return tempfile.NamedTemporaryFile(prefix="ethgreen_full_node_weight_proof_handler_executor_shutdown_trigger")
