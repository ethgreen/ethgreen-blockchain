...
from ethgreen.clvm.singleton import SINGLETON_LAUNCHER
from ethgreen.consensus.block_rewards import calculate_pool_reward
from ethgreen.consensus.coinbase import pool_parent_id
from ethgreen.pools.pool_wallet_info import PoolState, LEAVING_POOL, SELF_POOLING
...
from ethgreen.wallet.puzzles.singleton_top_layer import puzzle_for_singleton
...
def solution_to_pool_state(full_spend: CoinSpend) -> Optional[PoolState]:
    ...
    if num_args == 2:
        ...
        # This is referred to as p1 in the ethgreenlisp code
