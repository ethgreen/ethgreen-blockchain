...
import ethgreenConfig from '../util/config';
...
if (!handleSquirrelEvent()) {
  ...
  if (ensureSingleInstance() && ensureCorrectEnvironment()) {
    ...
    ethgreenConfig.loadConfig('mainnet');
    ...
    const createWindow = async () => {
      ...
      mainWindow.on('close', (e) => {
        ...
        if (decidedToClose || !ethgreenConfig.manageDaemonLifetime()) {
          return;
        }
        e.preventDefault();
        if (!isClosing) {
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              openExternal('https://twitter.com/ethgreenproject');
            },
          },
        ],
      },
