...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@ethgreen/core';
import {
...
import { mojo_to_ethgreen_string } from '../../../util/ethgreen';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_ethgreen_string(props.balance)} TXETH
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'ethgreen_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'ethgreen_addr://') {
