...
import {
  ...
  Fee,
  Form,
  TextField as EthgreenTextField,
  AlertDialog,
  CopyToClipboard,
  Flex,
  Card,
...
import { /* mojo_to_ethgreen_string, */ ethgreen_to_mojo } from '../../../util/ethgreen';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_ethgreen_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of ethgreen in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Ethgreen that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Ethgreen that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send ethgreen to coloured address. Please enter a ethgreen
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'ethgreen_addr://') {
    ...
    const amountValue = Number.parseFloat(ethgreen_to_mojo(amount));
    const feeValue = Number.parseFloat(ethgreen_to_mojo(fee));
