...
test('Create new Wallet and logout', async () => {
  ...
  // assert.equal(page.url(), 'file:///Users/jahifaw/Documents/Code/ETHgreen-testnet-playwright/ethgreen-blockchain/ethgreen-blockchain-gui/packages/gui/build/renderer/index.html#/wallet/add');
