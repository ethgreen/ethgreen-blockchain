...
import { OfferSummaryRecord } from '@ethgreen/api';
import { useTakeOfferMutation } from '@ethgreen/api-react';
import {
  AlertDialog,
  ethgreenToMojo,
  useOpenDialog,
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? ethgreenToMojo(fee) : new BigNumber(0);
