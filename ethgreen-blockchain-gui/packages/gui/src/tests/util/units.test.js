...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of ethgreen', () => {
      const result = units.getUnit('ethgreen');
    ...
    it('gets unit of ethgreen using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of ethgreen', () => {
      const result = units.getDisplay('ethgreen');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('ethgreen', 9);

      const result = units.getUnit('ethgreen');

      expect(result).toEqual(9);

      units.setUnit('ethgreen', 1);
    });
  });
  describe('#setDisplay', () => {
