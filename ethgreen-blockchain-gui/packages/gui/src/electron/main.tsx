...
import ethgreenEnvironment from '../util/ethgreenEnvironment';
import { setUserDataDir } from '../util/userData';
import { i18n } from '../config/locales';
import About from '../components/about/About';
import packageJson from '../../package.json';
import AppIcon from '../assets/img/ethgreen64x64.png';
...
// Set the userData directory to its location within ETHGREEN_ROOT/gui
setUserDataDir();
...
if (!handleSquirrelEvent()) {
  ...
  const ensureCorrectEnvironment = () => {
    ...
    if (!ethgreenEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
      app.quit();
      return false;
    }
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/ethgreen/ethgreen-blockchain/blob/main/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/ethgreen/ethgreen-blockchain/issues',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal('https://twitter.com/ETHgreenNetwork');
            },
          },
        ],
      },
