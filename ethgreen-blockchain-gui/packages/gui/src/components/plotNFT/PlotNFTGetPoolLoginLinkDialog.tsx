...
import { Button, CopyToClipboard, Flex, Link, Loading } from '@ethgreen/core';
import {
  Alert,
  Dialog,
  DialogActions,
...
import { useGetPoolLoginLinkQuery } from '@ethgreen/api-react';
import type { PlotNFT, PlotNFTExternal } from '@ethgreen/api';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/ethgreen/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
