...
import { useGetBlockQuery, useGetBlockRecordQuery } from '@ethgreen/api-react';
...
export default function Block() {
  ...
  const poolReward = mojoToETHgreen(calculatePoolReward(blockRecord.height));
  const baseFarmerReward = mojoToETHgreen(
    calculateBaseFarmerReward(blockRecord.height),
  );

  const ethgreenFees =
    blockRecord.fees !== undefined ? mojoToETHgreen(blockRecord.fees) : '';
