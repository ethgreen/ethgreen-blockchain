...
import { CardStep, Select, StateColor } from '@ethgreen/core';
import { useGetPlottersQuery } from '@ethgreen/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@ethgreen/api';
import type { Plotter, PlotterMap } from '@ethgreen/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => a == PlotterName.ETHGREENPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default ETHgreen Proof of Space plotter. If unsure,
            use the default ETHgreen Proof of Space plotter.
        </Trans>
      </Typography>
