...
import { defaultPlotter, toBech32m, fromBech32m } from '@ethgreen/api';
import {
  useStartPlottingMutation,
  useCreateNewPoolWalletMutation,
} from '@ethgreen/api-react';
import { useForm, SubmitHandler } from 'react-hook-form';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@ethgreen/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.ETHGREENPOS),
  });
