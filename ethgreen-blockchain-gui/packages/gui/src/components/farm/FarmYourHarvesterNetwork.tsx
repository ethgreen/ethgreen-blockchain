...
import { Table, FormatBytes, FormatConnectionStatus, Card } from '@ethgreen/core';
import { useService, useGetHarvesterConnectionsQuery } from '@ethgreen/api-react';
import type { Connection } from '@ethgreen/api';
