...
import type { CATToken, Wallet } from '@ethgreen/api';
  ...
  const [, options]: [TokenSelectOption, TokenSelectOption[]] = useMemo(() => {
    ...
    const ethgreenWalletSelection = [
      ...
      return {
        ...
        name: 'ETHgreen',
        symbol: currencyCode,
        displayName: `ETHgreen (${currencyCode})`,
        disabled: false,
        tail: '',
      };
    });
    ...
    const allOptions = [...ethgreenWalletSelection, ...catOptions];
