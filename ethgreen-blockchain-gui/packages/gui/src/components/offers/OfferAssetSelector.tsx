...
import { Wallet, WalletType, type CATToken } from '@ethgreen/api';
import { useGetCatListQuery, useGetWalletsQuery } from '@ethgreen/api-react';
import { Trans } from '@lingui/macro';
import { FormControl, InputLabel, MenuItem } from '@mui/material';
import { Select, useCurrencyCode } from '@ethgreen/core';
...
function OfferAssetSelector(props: OfferAssetSelectorProps) {
  ...
  const options: WalletOfferAssetSelection[] = useMemo(() => {
    ...
    return buildAssetSelectorList({
      ...
      otherRows,
      selectedWalletId,
      ethgreenCurrencyCode: currencyCode,
    });
