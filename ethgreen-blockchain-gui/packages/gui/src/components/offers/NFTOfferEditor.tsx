...
import type { NFTInfo, Wallet } from '@ethgreen/api';
import {
    ...
    if (
      ...
      switch (tokenWalletInfo.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToETHgreenLocaleString(
            walletBalance.spendableBalance,
            locale,
          );
          balance = mojoToETHgreen(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:
