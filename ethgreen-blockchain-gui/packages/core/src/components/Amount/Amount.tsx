...
import ethgreenToMojo from '../../utils/ethgreenToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isETHgreenCurrency = ['XFX', 'TXFX'].includes(currencyCode);
  const mojo = isETHgreenCurrency
    ? ethgreenToMojo(correctedValue)
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isETHgreenCurrency ? 12 : 3,
            'data-testid': dataTestid,
          },
          endAdornment: (
