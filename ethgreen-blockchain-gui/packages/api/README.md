...
This library provides support for TypeScript/JavaScript [ETHgreen](https://www.eth-green.com) apps to access the [ETHgreen Blockchain RPC](https://github.com/ethgreen/ethgreen-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:

- Making requests to the ETHgreen Blockchain RPC.
...
```ts
import Client, { Wallet } from '@ethgreen/api';
