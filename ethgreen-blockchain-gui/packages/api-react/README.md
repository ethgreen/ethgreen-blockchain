...
This library provides react hooks on the top of @ethgreen/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
- Automatically refresh queries when data changed (using events from ETHgreen Blockchain).
...
import { useGetPublicKeysQuery } from '@ethgreen/api-react';
...
import { store, api } from '@ethgreen/api-react';
