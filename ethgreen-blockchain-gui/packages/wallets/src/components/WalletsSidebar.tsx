...
export default function WalletsSidebar() {
  ...
  function handleOpenBlogPost() {
    openExternal('https://www.eth-green.com/cat2blog');
  }
      ...
      <WalletEmptyDialog>
        <ContentStyled>
          <Typography variant="h5" textAlign="center" color="grey">
            <Trans>Your custom asset tokens have been upgraded!</Trans>
          </Typography>
          <br />
          ...
          <ActionsStyled>
            <Flex gap={3} flexDirection="column" width="100%">
              <Button
                ...
                onClick={() =>
                  openExternal(
                    'https://cat1.eth-green.com/#publicKey=' +
                      privateKey.pk +
                      '&fingerprint=' +
                      fingerprint
                  )
          ...
          <Link target="_blank" href="https://www.eth-green.com/download/">
