...
import { TransactionType, WalletType } from '@ethgreen/api';
import type { Transaction } from '@ethgreen/api';
import { mojoToETHgreen, mojoToCAT, blockHeightToTimestamp } from '@ethgreen/core';
  ...
  data.forEach((item) => {
    ...
    points.push({
      ...
      tooltip:
        walletType === WalletType.CAT
          ? mojoToCAT(start)
          : mojoToETHgreen(start).toString(), // bignumber is not supported by react
    });
  });
