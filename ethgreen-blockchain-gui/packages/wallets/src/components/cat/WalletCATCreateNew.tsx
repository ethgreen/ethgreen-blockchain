...
import { ethgreenToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@ethgreen/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = ethgreenToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New ETHgreen Asset Token Wallet</Trans>
        </Back>
        <Card>
