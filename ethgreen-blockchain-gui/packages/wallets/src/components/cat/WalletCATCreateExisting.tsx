...
import { AlertDialog, Fee, Back, ButtonLoading, Card, Flex, Form, TextField } from '@ethgreen/core';
import { Box, Grid } from '@mui/material';
import { useDispatch } from 'react-redux';
import { useForm } from 'react-hook-form';
import { useNavigate } from 'react-router';
import { create_cc_for_colour_action } from '../../../modules/message';
import { ethgreenToMojo } from '@ethgreen/core';
...
export default function WalletCATCreateExisting() {
  ...
  async function handleSubmit(values: CreateExistingCATWalletData) {
    try {
      ...
      const feeMojos = ethgreenToMojo(fee || '0');
      ...
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          {asteroid 
            ...
            : <Trans>Create ETHgreen Asset Token Wallet from Existing TAIL</Trans>}
