...
import { Flex, Loading, MenuItem, useOpenDialog } from '@ethgreen/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@ethgreen/api-react';
import { Offers as OffersIcon } from '@ethgreen/icons';
