...
from ethgreen.simulator.block_tools import make_unfinished_block
...
class FakeServer:
    ...
    def get_full_node_outgoing_connections(self) -> List[ws.WSETHgreenConnection]:
        return []
...
async def run_sync_test(
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        ethgreen_init(root_path, should_check_keys=False, v1_db=(db_version == 1))
        ...
        try:
            ...
            peer: ws.WSETHgreenConnection = FakePeer()  # type: ignore[assignment]
...
async def run_sync_checkpoint(
    ...
    ethgreen_init(root_path, should_check_keys=False, v1_db=False)
    config = load_config(root_path, "config.yaml")
