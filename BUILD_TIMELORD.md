...
required to run a [Timelord](https://github.com/ethgreen/ethgreen-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/ethgreen/ethgreen-blockchain/blob/main/install-timelord.sh)
