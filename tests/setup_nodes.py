...
from ethgreen.daemon.server import WebSocketServer, create_server_for_daemon, daemon_launch_lock_path, singleton
from ethgreen.full_node.full_node_api import FullNodeAPI
from ethgreen.server.start_farmer import service_kwargs_for_farmer
from ethgreen.server.start_full_node import service_kwargs_for_full_node
from ethgreen.server.start_harvester import service_kwargs_for_harvester
from ethgreen.server.start_introducer import service_kwargs_for_introducer
from ethgreen.server.start_service import Service
from ethgreen.server.start_timelord import service_kwargs_for_timelord
from ethgreen.server.start_wallet import service_kwargs_for_wallet
from ethgreen.simulator.start_simulator import service_kwargs_for_full_node_simulator
...
from ethgreen.util.ints import uint16, uint32
...
async def setup_farmer(
    ...
    config["xeth_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "xeth")
