...
from ethgreenbip158 import PyBIP158
...
from ethgreen.plotting.create_plots import create_plots
...
from ethgreen.consensus.cost_calculator import NPCResult, calculate_cost_of_program
...
from ethgreen.plotting.plot_tools import PlotInfo, load_plots, parse_plot_info
...
from ethgreen.util.condition_tools import ConditionOpcode, conditions_by_opcode
...
class BlockTools:
    ...
    def init_plots(self, root_path: Path):
        ...
        try:
            ...
            args.pool_contract_address = encode_puzzle_hash(self.pool_ph, "xeth")
