...
wallet_program_files = set(
    [
        ...
        "ethgreen/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "ethgreen/wallet/puzzles/lock.inner.puzzle.clvm",
        "ethgreen/wallet/puzzles/p2_conditions.clvm",
        "ethgreen/wallet/puzzles/p2_delegated_conditions.clvm",
        "ethgreen/wallet/puzzles/p2_delegated_puzzle.clvm",
        "ethgreen/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "ethgreen/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "ethgreen/wallet/puzzles/p2_puzzle_hash.clvm",
        "ethgreen/wallet/puzzles/rl_aggregation.clvm",
        "ethgreen/wallet/puzzles/rl.clvm",
        "ethgreen/wallet/puzzles/sha256tree_module.clvm",
        "ethgreen/wallet/puzzles/singleton_top_layer.clvm",
        "ethgreen/wallet/puzzles/did_innerpuz.clvm",
        "ethgreen/wallet/puzzles/decompress_puzzle.clvm",
        "ethgreen/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "ethgreen/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "ethgreen/wallet/puzzles/block_program_zero.clvm",
        "ethgreen/wallet/puzzles/test_generator_deserialize.clvm",
        "ethgreen/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "ethgreen/wallet/puzzles/p2_singleton.clvm",
        "ethgreen/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "ethgreen/wallet/puzzles/pool_member_innerpuz.clvm",
        "ethgreen/wallet/puzzles/singleton_launcher.clvm",
        "ethgreen/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["ethgreen/wallet/puzzles/create-lock-puzzlehash.clvm", "ethgreen/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "ethgreen/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to ethgreen/wallet/puzzles, but not added to `wallet_program_files`
        """
