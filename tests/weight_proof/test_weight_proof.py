...
from ethgreen.server.start_full_node import SERVICE_NAME
...
from ethgreen.consensus.pot_iterations import calculate_iterations_quality
from ethgreen.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
