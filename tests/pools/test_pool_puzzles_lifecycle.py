...
from ethgreen.wallet.puzzles.p2_conditions import puzzle_for_conditions
from ethgreen.wallet.puzzles import singleton_top_layer
from ethgreen.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - ethgreen.pools.pool_puzzles.py
    - ethgreen.wallet.puzzles.pool_member_innerpuz.clvm
    - ethgreen.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
