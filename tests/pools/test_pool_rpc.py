...
from ethgreen.pools.pool_wallet_info import PoolWalletInfo, PoolSingletonState
...
from ethgreen.wallet.derive_keys import master_sk_to_local_sk
...
class TestPoolWalletRpc:
    ...
    def create_pool_plot(self, p2_singleton_puzzle_hash: bytes32, shuil=None) -> bytes32:
        ...
        args.pool_contract_address = encode_puzzle_hash(p2_singleton_puzzle_hash, "txeth")
