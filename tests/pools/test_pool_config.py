...
from ethgreen.pools.pool_config import PoolWalletConfig
from ethgreen.util.config import create_default_ethgreen_config, load_config, lock_config, save_config
...
def test_pool_config(tmp_path):
    ...
    create_default_ethgreen_config(test_root, ["config.yaml"])
