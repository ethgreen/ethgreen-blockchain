...
class TestCATTrades:
    ...
    async def test_cat_trades(self, wallets_prefarm):
        ...
        MAKER_ETHGREEN_BALANCE = initial_maker_balance - 100
        TAKER_ETHGREEN_BALANCE = initial_taker_balance - 100
        await time_out_assert(25, wallet_maker.get_confirmed_balance, MAKER_ETHGREEN_BALANCE)
        await time_out_assert(25, wallet_taker.get_unconfirmed_balance, TAKER_ETHGREEN_BALANCE)
        ...
        # ethgreen_for_cat
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(ethgreen_for_cat, fee=uint64(1))
        await asyncio.sleep(1)
        ...
        MAKER_ETHGREEN_BALANCE -= 2  # -1 and -1 for fee
        MAKER_NEW_CAT_BALANCE += 2
        TAKER_ETHGREEN_BALANCE += 0  # +1 and -1 for fee
        TAKER_NEW_CAT_BALANCE -= 2

        await time_out_assert(15, wallet_taker.get_unconfirmed_balance, TAKER_ETHGREEN_BALANCE)
        ...
        await time_out_assert(15, wallet_maker.get_confirmed_balance, MAKER_ETHGREEN_BALANCE)
        await time_out_assert(15, wallet_maker.get_unconfirmed_balance, MAKER_ETHGREEN_BALANCE)
        ...
        await time_out_assert(15, wallet_taker.get_confirmed_balance, TAKER_ETHGREEN_BALANCE)
        await time_out_assert(15, wallet_taker.get_unconfirmed_balance, TAKER_ETHGREEN_BALANCE)
        ...
        # cat_for_ethgreen
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(cat_for_ethgreen)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_CAT_BALANCE -= 4
        MAKER_ETHGREEN_BALANCE += 3
        TAKER_CAT_BALANCE += 4
        TAKER_ETHGREEN_BALANCE -= 3
        ...
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(
            ethgreen_for_multiple_cat, driver_dict=driver_dict
        )
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        ...
        MAKER_ETHGREEN_BALANCE -= 7
        MAKER_CAT_BALANCE += 8
        MAKER_NEW_CAT_BALANCE += 9
        TAKER_ETHGREEN_BALANCE += 7
        TAKER_CAT_BALANCE -= 8
        ...
        # multiple_cat_for_ethgreen
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(multiple_cat_for_ethgreen)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_ETHGREEN_BALANCE += 10
        TAKER_CAT_BALANCE += 11
        TAKER_NEW_CAT_BALANCE += 12
        TAKER_ETHGREEN_BALANCE -= 10
        ...
        # ethgreen_and_cat_for_cat
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(ethgreen_and_cat_for_cat)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_ETHGREEN_BALANCE -= 13
        MAKER_CAT_BALANCE -= 14
        MAKER_NEW_CAT_BALANCE += 15
        TAKER_ETHGREEN_BALANCE += 13
    ...
    async def test_trade_cancellation(self, wallets_prefarm):
        ...
        xeth_to_cat_amount = uint64(100)

        async with wallet_node_maker.wallet_state_manager.lock:
            cat_wallet_maker: CATWallet = await CATWallet.create_new_cat_wallet(
                wallet_node_maker.wallet_state_manager, wallet_maker, {"identifier": "genesis_by_id"}, xeth_to_cat_amount
            )
        ...
        await time_out_assert(15, cat_wallet_maker.get_confirmed_balance, xeth_to_cat_amount)
        await time_out_assert(15, cat_wallet_maker.get_unconfirmed_balance, xeth_to_cat_amount)
        maker_funds -= xeth_to_cat_amount
        ...
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(ethgreen_for_cat)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
