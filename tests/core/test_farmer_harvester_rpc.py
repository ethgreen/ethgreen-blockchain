...
from ethgreen.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
from ethgreen.plotting.manager import PlotManager
from ethgreen.protocols import farmer_protocol
from ethgreen.rpc.farmer_rpc_api import FarmerRpcApi
from ethgreen.rpc.farmer_rpc_client import FarmerRpcClient
from ethgreen.rpc.harvester_rpc_api import HarvesterRpcApi
...
from ethgreen.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xeth"), encode_puzzle_hash(new_ph_2, "xeth"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xeth"))
            ...
            assert config["farmer"]["xeth_target_address"] == encode_puzzle_hash(new_ph, "xeth")
            assert config["pool"]["xeth_target_address"] == encode_puzzle_hash(new_ph_3, "xeth")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xeth")
