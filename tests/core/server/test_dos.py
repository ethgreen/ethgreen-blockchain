...
from ethgreen.protocols.shared_protocol import Handshake
...
class TestDos:
    ...
    async def test_large_message_disconnect_and_ban(self, setup_two_nodes):
        ...
        ssl_context = ssl_context_for_client(
            server_2.ethgreen_ca_crt_path, server_2.ethgreen_ca_key_path, server_2.p2p_crt_path, server_2.p2p_key_path
        )
