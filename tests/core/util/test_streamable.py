...
from ethgreen.protocols.wallet_protocol import RespondRemovals
...
from ethgreen.types.blockchain_format.sized_bytes import bytes4, bytes32
...
from ethgreen.util.streamable import (
    ConversionError,
    DefinitionError,
    InvalidSizeError,
    InvalidTypeError,
