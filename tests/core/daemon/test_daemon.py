...
from ethgreen.daemon.keychain_server import DeleteLabelRequest, SetLabelRequest
from ethgreen.daemon.server import WebSocketServer, service_plotter
...
from ethgreen.util.keychain import KeyData
from ethgreen.daemon.keychain_server import GetKeyRequest, GetKeyResponse, GetKeysResponse
from ethgreen.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE
from ethgreen.util.ws_message import create_payload
from tests.core.node_height import node_height_at_least
from ethgreen.simulator.time_out_assert import time_out_assert_custom_interval, time_out_assert
...
def mock_daemon_with_services():
    ...
    return Daemon(
        services={
            ...
            "ethgreen_plotter": [Service(True), Service(True)],
        },
        connections={},
    )
...
async def test_daemon_simulation(self_hostname, daemon_simulation):
    ...
    data = {}
    payload = create_payload("get_blockchain_state", data, service_name, "ethgreen_full_node")
    await ws.send_str(payload)
