...
from ethgreen.data_layer.data_layer_util import NodeType, Side, Status
...
class ETHgreenRoot:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        kwargs["env"]["ETHGREEN_ROOT"] = os.fspath(self.path)
        kwargs["env"]["ETHGREEN_KEYS_ROOT"] = os.fspath(self.path)
        ...
        modified_args: List[Union[str, os_PathLike_str]] = [
            self.scripts_path.joinpath("ethgreen"),
            "--root-path",
            self.path,
            *args,
        ]
