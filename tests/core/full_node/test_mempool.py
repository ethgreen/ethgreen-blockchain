...
from ethgreen.util.condition_tools import conditions_for_solution
...
from ethgreen.full_node.mempool_check_conditions import parse_condition_args, parse_condition
...
#                    assert npc_result.npc_list[0].conditions == []
    ...
    async def test_invalid_coin_spend_coin(self, two_nodes):
        ...
        blocks = bt.get_consecutive_blocks(
            ...
            farmer_reward_puzzle_hash=reward_ph,
            pool_reward_puzzle_hash=reward_ph,
            donationwallet_reward_puzzle_hash=reward_ph,
        )
        full_node_1, full_node_2, server_1, server_2 = two_nodes
