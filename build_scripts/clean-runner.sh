...
rm -rf ../venv || true
rm -rf venv || true
rm -rf ethgreen_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf ethgreen-blockchain-gui/build || true
rm -rf ethgreen-blockchain-gui/daemon || true
rm -rf ethgreen-blockchain-gui/node_modules || true
rm ethgreen-blockchain-gui/temp.json || true
( cd "$PWD/ethgreen-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @ethgreen/notarize-cli || true
