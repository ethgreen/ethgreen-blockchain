...
Write-Output "   ---"
Write-Output "Get ETHGREEN_INSTALLER_VERSION"
# The environment variable ETHGREEN_INSTALLER_VERSION needs to be defined
$env:ETHGREEN_INSTALLER_VERSION = python .\build_scripts\installer-version.py -win
...
Write-Output "   ---"
Write-Output "Install ethgreen-blockchain wheels into venv with pip"
Write-Output "   ---"
...
Write-Output "pip install ethgreen-blockchain"
pip install --no-index --find-links=.\win_build\ ethgreen-blockchain
...
Write-Output "   ---"
Copy-Item "dist\daemon" -Destination "..\ethgreen-blockchain-gui\" -Recurse
